...
public class ResultObj {
     ...
     * 预约通过
     */
    public static final ResultObj ORDER1_SUCCESS = new ResultObj(SysConstant.CODE_SUCCESS,SysConstant.ORDER1_SUCCESS);
    /**
     * 预约不通过
     */
    public static final ResultObj ORDER1_ERROR = new ResultObj(SysConstant.CODE_ERROR,SysConstant.ORDER1_ERROR);
    /**
     * 重置成功
     */
