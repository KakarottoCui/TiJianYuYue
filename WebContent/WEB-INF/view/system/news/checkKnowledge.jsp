...
<body class="childrenBody">
	...
	<div id="checkkonwledgeToolBar" style="display: none;">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 270px;">
						<input type="text" id="title" name="title" lay-verify="required"
							placeholder="请输入小知识标题" autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 270px;">
						<textarea class="layui-textarea" name="context"
							lay-verify="content" id="context" rows="10" cols="200"></textarea>
					</div>
				</div>
			</div>
		...
		layui
				...
				.use(
						...
						function() {
							...
							//监听头部工具栏事件
							table.on("toolbar(checkkonwledgeTable)", function(
									obj) {
								switch (obj.event) {
								case 'add':
									openAddKnowledge();
												...
												if (layEvent === 'del') { //删除
													layer
															.confirm(
																	...
																	function(index) {
																		//向服务端发送删除指令
																		$.post("/examination/checkknowledge/deleteCheckKnowledge.action",{id : data.id},
																						function(res) {
																							layer.msg(res.msg);
																							//刷新数据表格
																							tableIns.reload();
								...
								mainIndex = layer
										.open({
											...
											success : function(index) {
												//清空表单数据
												$("#dataFrm")[0].reset();
												url = "/examination/checkknowledge/addCheckKnowledge.action";
											}
										});
							}
								...
								mainIndex = layer
										.open({
											...
											success : function(index) {
												...
												url = "/examination/checkknowledge/updateCheckKnowledge.action";
											}
										});
							}
