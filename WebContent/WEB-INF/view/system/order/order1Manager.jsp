...
<!-- 				<div class="layui-input-inline" style="padding: 5px"> -->
<!-- 					<input type="text" name="order1name" autocomplete="off" -->
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" id="order1name" name="uname" lay-verify="required"
							placeholder="请输入体检人姓名" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">性别:</label>
					<div class="layui-input-inline">
						<div class="layui-input-inline" id="usex">
		                    <input type="radio" name="usex" value="1" checked="checked" title="男">
...
<!-- 							placeholder="请输入体检总价格" autocomplete="off" class="layui-input" readonly> -->
<!-- 						<button type="button" class="layui-btn layui-btn-normal layui-icon layui-icon-search layui-btn-radius layui-btn-sm" id="calPrice">计算总价</button> -->
<!-- 					</div> -->
<!-- 				</div> -->
			</div>
    ...
    layui.extend({
        ...
        $("#calPrice").click(function () {
	        ...
	        for ( var x in packages) {
	        	if (packages[x].id == $('#packageid').val()) {
	        		pprice = packages[x].price;
	        	}
	        ...
	        for ( var x in projects) {
	        	for (var i in tagIns2.selected) {
	        		if (projects[x].pid == tagIns2.selected[i].pid) {
		        		ppprice = parseInt(ppprice) + parseInt(projects[x].price);
		        	}
	        	}
	        	
	        	
			}
	        $('#price').val(parseInt(pprice) + parseInt(ppprice));
	    });
							...
							mainIndex = layer
									.open({
										...
										success : function(index) {
											//清空表单数据
											$("#dataFrm")[0].reset();
											url = "/examination/order1/addOrder1.action";
										}
									});
						}
...
// 							var params = $("#dataFrm").serialize();
							var params = {
								...
								usex: $('#usex input[name="usex"]:checked ').val(),
								uphone: $('#uphone').val(),
